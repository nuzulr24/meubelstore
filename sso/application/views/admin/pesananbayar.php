			...
			if($rows > 0){
				...
				foreach($pro->result() as $r){
					...
					switch($this->func->getUserdata($r->usrid,"level")){
						case 2: $lepel = "<span class='badge badge-primary'>Reseller</span>";
						break;
						case 3: $lepel = "<span class='badge badge-primary'>Agen</span>";
						break;
						case 4: $lepel = "<span class='badge badge-primary'>Agen Premium</span>";
						break;
						case 5: $lepel = "<span class='badge badge-primary'>Distributor</span>";
						break;
					}
		?>
			<tr>
				...
				<td><?=$this->func->getProfil($r->usrid,"nama","usrid")?> &nbsp;<?=$lepel?></td>
