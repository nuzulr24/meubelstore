		...
		<div class="container m-b-75">
			...
			<div class="tab">
				<div class="tab-header">
					...
					<a id="navinformasi" class="navlink btn btn-info m-r-8 m-b-8" href="javascript:void(0)" data-link="#informasi"><i class="fas fa-users-cog"></i> Pengaturan</a>
					<a class="btn btn-danger m-b-8" href="javascript:void(0)" onclick="signoutNow()"><i class="fas fa-power-off"></i> Keluar</a>
				</div>
