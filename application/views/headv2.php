...
$keywords = "";
$img = (isset($img)) ? $img : base_url("blackexpo/assets/img/".$set->favicon);
...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="<?=base_url("blackexpo/assets/img/".$set->favicon)?>"/>
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-top">
			<div class="container">
				<a class="navbar-brand" href="<?=site_url()?>">
					<img src="<?= base_url('sso/assets/img/'.$set->logo) ?>" height="60" />
				</a>
